        ...
        <div className="lobby-form">
          ...
          <div className="lobby-actions">
            ...
            <div className="ai-section">
              ...
              {showAIOptions && (
                <div className="ai-options mt-3 p-4 bg-gray-50 rounded-lg border-2 border-gray-200 space-y-3">
                  ...
                  <div className="flex flex-col gap-2">
                    <button
                      className="btn btn-sm bg-green-500 text-white hover:bg-green-600 py-2"
                    ...
                    <button
                      className="btn btn-sm bg-yellow-500 text-white hover:bg-yellow-600 py-2"
                      onClick={() => handleCreateAIGame(AIDifficulty.NORMAL)}
                      disabled={isCreating}
                    >
                    ...
                    <button
                      className="btn btn-sm bg-red-500 text-white hover:bg-red-600 py-2"
                      onClick={() => handleCreateAIGame(AIDifficulty.HARD)}
                      disabled={isCreating}
                    >
                      🔴 {isSpanish ? 'Difícil' : 'Hard'} -{' '}
                      {isSpanish ? 'Estrategia avanzada' : 'Advanced strategy'}
                    </button>
                  </div>
                </div>
              )}
