              ...
              >
                <div className="card-header">
                  <div className="card-name text-sm font-semibold">
                    {card.name[gameLanguage as keyof typeof card.name] ||
                      card.name.es}
                  </div>
                ...
                <div className="card-description text-xs text-gray-600 mt-2">
                  {card.description[
                    gameLanguage as keyof typeof card.description
                  ] || card.description.es}
                </div>
                <div className="card-footer mt-2 flex justify-between items-center">
                  {card.color && (
                    <div
