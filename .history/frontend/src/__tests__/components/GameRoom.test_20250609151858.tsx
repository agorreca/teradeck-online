  ...
  useTranslation: () => ({
    t: (key: string) => {
      const translations: Record<string, any> = {
        ...
        'ui.gameRoom.waiting': 'Esperando al anfitrión para comenzar el juego...',
...
describe('GameRoom Component', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should show waiting message for non-host players', () => {
      ...
      expect(screen.getByText('Esperando al anfitrión para comenzar el juego...')).toBeInTheDocument();
    });
    ...
    it('should show start game button for host', () => {
      ...
      expect(screen.queryByText('Esperando al anfitrión para comenzar el juego...')).not.toBeInTheDocument();
    });
  });
  ...
  describe('Player Status Display', () => {
    ...
    it('should correctly identify current player', () => {
      ...
      const currentPlayerElement = screen.getByText('TestPlayer').closest('.player-item');
