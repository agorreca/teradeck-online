...
describe('OperationModal Component', () => {
  ...
  describe('Modal Visibility', () => {
    it('should not render when closed', () => {
      ...
      expect(
        screen.queryByText('Selecciona módulo para robar')
  ...
  describe('Recruit Ace Operation', () => {
    it('should render recruit ace interface', () => {
      ...
      expect(
        screen.getByText('Selecciona módulo para robar')
      ).toBeInTheDocument();
    ...
    it('should handle module selection for recruit ace', () => {
      ...
      expect(moduleButton.closest('button')).toHaveClass(
        'ring-2',
        'ring-blue-500'
      );
    });
    ...
    it('should show no valid modules message when none available', () => {
      ...
      expect(
        screen.getByText('No hay módulos válidos para robar')
      ).toBeInTheDocument();
    });
  });
  ...
  describe('Architect Change Operation', () => {
    ...
    it('should progress to step 2 when first module selected', () => {
      ...
      expect(
        screen.getByText('Primer módulo seleccionado:')
      ).toBeInTheDocument();
  ...
  describe('State Management', () => {
    it('should reset selection when modal reopens', () => {
      ...
      expect(moduleButtonAgain.closest('button')).not.toHaveClass(
        'ring-2',
        'ring-blue-500'
      );
    });
