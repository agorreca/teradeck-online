  ...
  useTranslation: () => ({
    t: (key: string, options?: any) => {
      const translations: Record<string, string> = {
        ...
        'targeting.targetInstructions.bug': 'Selecciona un módulo enemigo para infectar',
        'targeting.targetInstructions.patch': 'Selecciona un módulo propio para reparar',
        'targeting.targetInstructions.operation': 'Selecciona objetivos para la operación',
...
describe('TargetingOverlay Component', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    const { getCardTargetRequirements } = require('../../../../shared/src/utils/targeting');
  ...
  describe('Visibility and Rendering', () => {
    ...
    it('should not render when no card is being played', () => {
      const props = {
        ...defaultProps,
        targetingState: { ...defaultProps.targetingState, cardBeingPlayed: null },
      };
  ...
  describe('Module Targets', () => {
    ...
    it('should disable invalid module targets', () => {
      ...
      const invalidModuleButton = screen.getByText('Backend API').closest('button');
  ...
  describe('Instructions Display', () => {
    ...
    it('should show patch card instructions', () => {
      ...
      expect(screen.getByText('Selecciona un módulo propio para reparar')).toBeInTheDocument();
    });
    ...
    it('should show operation card instructions', () => {
      ...
      expect(screen.getByText('Selecciona objetivos para la operación')).toBeInTheDocument();
    });
  });
