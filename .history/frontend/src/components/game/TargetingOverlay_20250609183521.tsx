...
import { getCardTargetRequirements } from '@shared/utils/targeting';
...
export function TargetingOverlay({
  ...
  const renderPlayerTargets = () => {
    ...
    return (
      <div className="targeting-section">
        <h3 className="targeting-section-title">{t('targeting.players')}</h3>
          ...
          {playerTargets.map((target, index) => (
            ...
            >
              <div className="player-info">
                ...
                <span className="player-type">{t('targeting.player')}</span>
              </div>
  ...
  const renderModuleTargets = () => {
    ...
    return (
      <div className="targeting-section">
        <h3 className="targeting-section-title">{t('targeting.modules')}</h3>
        ...
        <div className="targeting-instructions">
          ...
          {requirements.minTargets > 0 && (
            <p className="targeting-requirements">
              {t('targeting.targetRequired', {
                count: requirements.minTargets,
              })}
            </p>
          )}
        </div>
