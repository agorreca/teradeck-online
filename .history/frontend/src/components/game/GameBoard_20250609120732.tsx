        ...
        <div className="game-center">
          ...
          <div className="flex justify-center gap-4 mb-6">
            ...
            <div className="deck bg-blue-600 text-white rounded-lg p-4 text-center min-w-[120px]">
              ...
              <div className="text-lg font-bold">{gameState.deck.length} cartas</div>
            </div>
            ...
            <div className="discard bg-gray-600 text-white rounded-lg p-4 text-center min-w-[120px]">
              ...
              {gameState.discardPile.length > 0 ? (
                <div className="bg-gray-700 rounded p-2 mb-2 min-h-[80px] flex flex-col justify-center">
                  <div className="text-xs font-semibold text-yellow-300 mb-1">
                    {gameState.discardPile[gameState.discardPile.length - 1].name[gameState.language]}
                  </div>
                  <div className="text-xs text-gray-300">
                    {t(`ui.cards.${gameState.discardPile[gameState.discardPile.length - 1].type}`)}
                  </div>
                  {gameState.discardPile[gameState.discardPile.length - 1].color && (
                    <div className={`w-4 h-2 mx-auto mt-1 rounded ${getModuleColorClass(gameState.discardPile[gameState.discardPile.length - 1].color)}`}></div>
                  )}
                </div>
              ) : (
              ...
              <div className="text-sm">{gameState.discardPile.length} cartas</div>
            </div>
          </div>
        </div>
