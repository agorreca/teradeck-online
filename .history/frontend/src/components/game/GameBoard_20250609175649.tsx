          ...
          <div className="player-hand">
            ...
            <div className="hand-cards grid grid-cols-1 gap-2 max-h-64 overflow-y-auto">
              {currentPlayer.hand.map(card => {
                ...
                if (!playability.canPlay) {
                  cardClasses.push('not-playable', 'opacity-60', 'cursor-not-allowed');
                } else if (isCurrentPlayerTurn) {
                  cardClasses.push('playable', 'cursor-pointer', 'hover:scale-105', 'hover:shadow-lg');
                } else {
                ...
                return (
                  <div key={card.id} className="relative">
                    <button
                      ...
                      onClick={() => playability.canPlay && isCurrentPlayerTurn && handleCardPlay(card)}
                    ...
                    >
                      ...
                      {!playability.canPlay && playability.reason && (
                    ...
                    {!playability.canPlay && playability.reason && (
                      <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-800 text-white text-xs rounded-lg shadow-lg opacity-0 pointer-events-none group-hover:opacity-100 transition-opacity z-10">
                        <div className="text-center">
                          <div className="font-semibold mb-1">No se puede jugar</div>
                          <div>{playability.reason}</div>
                        </div>
