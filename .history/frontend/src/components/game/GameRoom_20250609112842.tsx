...
export function GameRoom() {
  ...
  console.log('Debug GameRoom:', {
    ...
    gameStatePlayersDetailed: gameState.players.map(p => ({ id: p.id, nickname: p.nickname, isAI: p.isAI })),
    currentPlayer,
    currentPlayerSearch: gameState.players.find(p => p.id === currentPlayerId),
    isHost,
    isAIGame,
    humanPlayers,
    humanPlayersDetailed: gameState.players.filter(p => !p.isAI).map(p => ({ id: p.id, nickname: p.nickname })),
    aiPlayers,
    canStart,
  });
